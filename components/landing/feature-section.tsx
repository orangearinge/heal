    ...
    <section id='features'>
      <div className="py-24">
        <div className="mx-auto w-full  px-6">
          <div>
            <h2 className="text-foreground max-w-2xl text-balance text-4xl font-normal">Empowering developers with{" "} <span className='text-muted-foreground'>AI-driven solutions</span></h2>
          </div>
